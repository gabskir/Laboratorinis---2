...
void skaitymas(deque<studentas>& grupe, studentas& temp){
    ...
    //pirma strategija kai naudojami du nauji dekai
    if (strategija == 0) {
        deque<studentas> broliaiSaunuoliai;
        deque<studentas> pasidaveliai;
    ...
    //antra strategija - naudojant viena nauja deka - pasidaveliai ir trinant is grupes
        deque<studentas> pasidaveliai;
...
void budas1 (deque<studentas>& grupe, deque<studentas>& broliaiSaunuoliai, deque<studentas>& pasidaveliai) {
    auto start = std::chrono::high_resolution_clock::now();
...
void budas2(deque<studentas>& grupe, deque<studentas>& pasidaveliai) {
    auto start = std::chrono::high_resolution_clock::now();
